...
def run_sequential(args, logger):
    ...
    if args.learner in ['masaj_learner', 'rode_learner']:
        scheme["roles"] = {"vshape": (1,), "group": "agents", "dtype": th.long}
        preprocess["roles"] = ("roles_onehot", [OneHot(out_dim=args.n_roles)])
        if args.actions_dtype == th.long():
            scheme["role_avail_actions"] = {"vshape": (env_info["n_actions"],), "group": "agents", "dtype": th.int}
