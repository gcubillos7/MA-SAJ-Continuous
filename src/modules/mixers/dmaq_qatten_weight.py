...
class Qatten_Weight(nn.Module):
    def __init__(self, args):
        ...
        self.unit_dim = args.unit_dim # state-action dim 
        self.n_actions = args.n_actions # state-action dim
        self.sa_dim = self.state_dim + self.n_agents * self.n_actions # state-action dim
